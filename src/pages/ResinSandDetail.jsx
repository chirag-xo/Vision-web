...
const ResinSandDetail = () => {
    // Since we only have one product in this category, we can find it directly
    // based on the ID or the category slug/sub-product structure.
    const productCategory = productsData.find(p => p.slug === 'resin-coated-sand');
    const product = productCategory?.subProducts?.[0];
        ...
        <div className="section">
            <div className="container">
                <div style={{ marginBottom: '2rem' }}>
                    ...
                    <Link to="/products/resin-coated-sand" style={{ color: '#64748b' }}>Resin Coated Sand</Link>
                    <span style={{ margin: '0 0.5rem', color: '#cbd5e1' }}>/</span>
...
export default ResinSandDetail;
